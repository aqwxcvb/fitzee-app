...
const FavoriteFilledIcon = ({ size = 24, strokeWidth = 2, ...props }: IconProps) => (
    <Svg viewBox="0 0 64 64" fill="none" width={size} height={size} {...props}>
...
export default cssInterop(FavoriteFilledIcon, {
    className: {
